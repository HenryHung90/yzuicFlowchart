...
!function() {
    ...
    function _(E) {
        try {
            return null === E ? R : void 0 === E ? O : e(E) ? T : Object.prototype.toString.call(E)
        } catch {
            return s
        }
    }
    ...
    function t(E) {
        return E.length > o ? E.slice(0, o) + "\u2026" : E
    }
    function n(E) {
        let _ = typeof E;
        return "function" === _ || "symbol" === _ ? E.toString() : "bigint" === _ && `${E.toString()}n`
    }
    function S(E) {
        try {
            var e = _(E)
            ...
            case s:
                return Object.keys(E).map((_=>{
                    let e;
                    "function" == typeof Object.getOwnPropertyDescriptor(E, _).get ? e = "\u2026" : (e = E[_],
                    n(e) && (e = n(e))),
                    N[_] = e
                }
                )),
